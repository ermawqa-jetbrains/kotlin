...
public fun BaseDriver_addListener__TypesOfArguments__Swift_Array_Swift_String__Vararg_____reverse(self: BaseDriver, queryKeys: kotlin.collections.List<kotlin.String>): Unit {
    val __self = kotlin.native.internal.ref.createRetainedExternalRCRef(self)
    val __queryKeys = queryKeys.objcPtr()
...
public fun Driver_addListener__TypesOfArguments__Swift_Array_Swift_String__Vararg__anyU20main__Driver_Listener____reverse(self: Driver, queryKeys: kotlin.collections.List<kotlin.String>, listener: Driver.Listener): Unit {
    val __self = kotlin.native.internal.ref.createRetainedExternalRCRef(self)
    val __queryKeys = queryKeys.objcPtr()
