...
public abstract class AbstractLongTimeSource(protected val unit: DurationUnit) : TimeSource.WithComparableMarks {
     ...
     * as this will cause the returned time marks to flip over the future/past boundary or to become infinitely distant.
     */
     ...
     * as this will cause the returned time mark to flip over the future/past boundary or to become infinitely distant.
     *
