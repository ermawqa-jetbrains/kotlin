...
const val messageMemory = "memory is deprecated. Consider to use kotlin.wasm.unsafe.wasmMemory or try to update your dependencies"
const val messageWasmExports = "wasmExports is not available anymore. Please remove this usage from the code or try to update project dependencies."
